...
contract Auction {
    ...
    constructor() {
        ...
        description = "Certificado de incapacidad de la clinica paciente Kevin Dussan";
        imageURI = "https://marketplace.canva.com/EAFFFbUMFcI/1/0/1600w/canva-certificado-reconocimiento-cl%C3%A1sico-elegante-azul-y-dorado-RO7Ro0gP-WQ.jpg";
        basePrice = 0.1 ether;   
